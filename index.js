...
*/
const A187 = 'Dark mini bot'; // JANGAN UBAH-UBAH INFO!!!
...
const premium = require("./lib/prem.json");
...
conn.sendMessage(id, '*Untuk menggunakan fitur nama ketik !nama (nama lu) contoh:!nama bot*' ,MessageType.text);
}
else if (text == '!wiki'){
conn.sendMessage(id, '*Untuk menggunakan fitur wiki ketik !wiki (yang mau di cari) contoh:!wiki anonymous*' ,MessageType.text);
}
else if (text == '!nulis'){
conn.sendMessage(id, '*Untuk menggunakan fitur nulis ketik !nulis (teks) contoh:!nulis saya bot*' ,MessageType.text);
}
else if (text == '!pasangan'){
conn.sendMessage(id, '*Untuk menggunakan fitur pasangan ketik !pasangan (nama & nama) contoh:!pasangan bot & bot*' ,MessageType.text);
}
else if (text == '!lirik'){
conn.sendMessage(id, '*Untuk menggunakan fitur lirik ketik !lirik (nama lagu) contoh:!lirik cinta luar biasa*' ,MessageType.text);
}
else if (text == '!listjs'){
...
conn.sendMessage(id, '*Untuk menggunakan fitur chord ketik !chord (nama lagu) contoh:!chord cinta luar biasa*' ,MessageType.text);
}
else if (text == '#udin'){
conn.sendMessage(id, '*Liat list menu anjing*' ,MessageType.text);
}
else if (text == '!sholat'){
conn.sendMessage(id, '*Untuk menggunakan fitur sholat ketik !sholat (daerah) ketik !listjs untuk melihat daerah yang tersedia. contoh:!sholat jakarta*' ,MessageType.text);
}
else if (text == '!harinasional'){
conn.sendMessage(id, '*Untuk menggunakan fitur harinasional ketik !harinasional (tanggal) contoh:!harinasional 17 agustus*' ,MessageType.text);
}
else if (text == '!infoanime'){
conn.sendMessage(id, '*Untuk menggunakan fitur infoanime ketik !infoanime (judul) contoh:!infoanime boruto*' ,MessageType.text);
}
else if (text == 'filmanime'){
conn.sendMessage(id, '*Untuk menggunakan fitur filmanime ketik !filmanime (judul) contoh:!filmanime boruto*' ,MessageType.text);
}
else if (text == '!bitly'){
conn.sendMessage(id, '*Untuk menggunakan fitur bitly ketik !bitly contoh:!bitly https://bintoroproject.wordpress.com*' ,MessageType.text);
}
else if (text == '!ownerbot'){
conn.sendMessage(id, '*https://wa.me/+628168646011 ini adalah nomer tuan saya*' ,MessageType.text);
}
else if (text == '!namaninja'){
conn.sendMessage(id, '*Untuk menggunakan fitur namaninja ketik !namaninja (nama) contoh:!namaninja bot*' ,MessageType.text);
}
else if (text == '!alay'){
conn.sendMessage(id, '*Untuk menggunakan fitur alay ketik !alay (teks) contoh:!alay woyyy*' ,MessageType.text);
}
else if (text == '!bot'){
...
conn.sendMessage(id, '*Untuk menggunakan fitur infoig ketik !infoig contoh:!infoig anker_2412*' ,MessageType.text);
}
else if (text == '!spamcall'){
conn.sendMessage(id, '*Untuk menggunakan fitur spamcall ketik !spamcall (nomer lu) contoh:!spamcall 83168646011*' ,MessageType.text);
}
else if (text == '!spamsms'){
conn.sendMessage(id, '*Untuk menggunakan fitur spamsms ketik !spamsms (nomer lu) contoh:!spamsms 83168646011*' ,MessageType.text);
}
else if (text == 'p'){
...
if (!premium) return conn.sendMessage(id, 'Fitut premium hanya bisa di gunakan oleh mem premium ketik $daftar untuk menjadi mem premium', MessageType.text)
else
    ...
    .then((res) => {
      imageToBase64(res.data.result)
        .then(
          (ress) => {
            conn.sendMessage(id, '[WAIT] Sedang di proses⏳ silahkan tunggu', MessageType.text)
...
axios.get(`https://mhankbarbar.herokuapp.com/api/twit?url=${teks}&apiKey=zFuV88pxcIiCWuYlwg57`).then((res) => {
	conn.sendMessage(id, '[WAIT] Sedang di proses⏳ silahkan tunggu', MessageType.text)
    let hasil = `nih…Berhasil$ silahkan klik link di bawah untuk mendownload hasilnya$\nKlik link dibawahðŸ—¡ï¸\n\nSize: ${res.data.filesize}\n\nLink: ${res.data.result}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`http://scrap.terhambar.com/tiktokfull?link=${tictoc}`).then((res) => {
	 conn.sendMessage(id, '[WAIT] Sedang di proses⏳ silahkan tunggu', MessageType.text)
     let titoe = `Nih…Berhasil$$$ Silahkan klik link dibawah ini untuk mendownload hasilnya$ \nKlik link dibawahðŸ—¡ï¸\n\nJudul: ${res.data.deskripsi} \n\nDurasi: ${res.data.durasi}\n\nNama: ${res.data.nama}\n\nUrl: ${res.data.urlvideo}`;
...
axios.get(`https://arugaz.herokuapp.com/api/spamsms?no=${teks}&jum=5`).then((res) => {
	conn.sendMessage(id, '[WAIT] Sedang di proses⏳ silahkan tunggu', MessageType.text)
    let hasil = ` *INFO SPAM SMS 5 PESAN* \n\n _${res.data.logs}_`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
axios.get(`https://arugaz.herokuapp.com/api/resep?query=${teks}`).then((res) => {
	conn.sendMessage(id, '[WAIT] Sedang di proses⏳ silahkan tunggu', MessageType.text)
    let hasil = `Resep Makanan ${teks}:\n\nJudul:${res.data.result.difficulty}\n\nKata Kunci:${res.data.result.key}\n\nWaktu:${res.data.result.times}\n\nJudul:${res.data.result.title}\n\n Porsi:${res.data.result.serving}`;
    conn.sendMessage(id, hasil ,MessageType.text);
})
}
...
conn.sendMessage(id, help.help(id, A187, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '!menu'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, menusticker.menusticker(id, A187, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '!menuinformantion'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
var tahun = date.getFullYear();
var bulan = date.getMonth();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, menuinformantion.menuinformantion(id, A187, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '!menueducation'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
var tahun = date.getFullYear();
var bulan = date.getMonth();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, menueducation.menueducation(id, A187, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
if (text == '!menuothers'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
...
var tampilTanggal = "TANGGAL: " + hari + ", " + tanggal + " " + bulan + " " + tahun;
var tampilWaktu = "JAM: " + jam + ":" + menit + ":" + detik;
conn.sendMessage(id, menuothers.menuothers(id, A187, corohelp, tampilTanggal, tampilWaktu, instagram, nomer, aktif, groupwhatsapp, youtube) ,MessageType.text);
}
else if (text == '!donate'){
const corohelp = await get.get('https://covid19.mathdro.id/api/countries/id').json()
var date = new Date();
